  ...
  render (){
    return (
        <aside className="menu bar-system right-0 ">
            <a classame="center-align" target="_blank" href="http://webmail.qygconsultores.com/Mondo/lang/sys/login.aspx">  <img src={require(`./../../../../media/images/png/EMail-Green-1.png`)}  alt="E-Mail"/> </a>
